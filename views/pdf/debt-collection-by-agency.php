...
<div style="padding: 5mm 5mm; font-size: 8.5px;<?php if ($page != $pageCount) : ?>page-break-after: always;<?php endif; ?>">
    <h4 class="text-center">売掛買掛一覧（リース会社別）</h4>
...
foreach ($dataProvider->models as $model) {
    echo $this->render('iv-credit-debt-collection-by-agency', ['model' => $model, 'targetTerm' => $targetTerm, 'dataProvider' => $dataProvider, 'totals' => $totals, 'searchModel' => $searchModel, 'span' => $span]);
}
?>
        </tbody>
    </table>
