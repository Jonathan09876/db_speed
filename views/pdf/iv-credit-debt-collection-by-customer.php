...
foreach($model->contractDetails as $detail) : ?>
    <tr>
        ...
        <td class="sticky-cell3 border-bottom"><?= $customer->getName() ?></td>
        <td class="sticky-cell4 border-bottom"><?= $model->contractNumber ?></td>
    ...
    if ($detail->contract_detail_id == $last_cdid) :
        ...
        foreach(explode(',', $totals[$customer->customer_id]['cdids']) as $cdid) {
    ...
    <tr class="total-row">
        <td colspan="10" class="border-bottom text-center sticky-cell1" style="background-color:#ffffdd"><?= $customer->name ?></td>
