...
?>
    <tr>
        <td class="sticky-cell sticky-cell1 border-bottom" rowspan="<?= $rowspan ?>"><?= Html::a($customer->customer_code, ['/aas/customer', 'id' => $customer->customer_id], ['target' => '_blank']) ?></td>
        <td class="sticky-cell sticky-cell2 border-bottom" rowspan="<?= $rowspan ?>"><?= $customer->clientContract->repaymentPattern->name ?></td>
        <td class="sticky-cell sticky-cell3 border-bottom" rowspan="<?= $rowspan ?>"><?= Html::a($customer->getName(), ['/aas/customer', 'id' => $customer->customer_id], ['target' => '_blank']) ?></td>
