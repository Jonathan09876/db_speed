...
?>
    <tr>
        ...
        <td class="sticky-cell3 border-bottom" rowspan="2"<?= $customerBgColor ? " style=\"background-color:{$customerBgColor}!important;\"" : '' ?>><?= Html::a($customer->getName(), ['/aas/customer', 'id' => $customer->customer_id]) ?></td>
        ...
        <td class="sticky-cell5 border-bottom" rowspan="2"><?= $detail->taxApplication->application_name ?></td>
        <td class="sticky-cell6 "><?= $detail->term_start_at ?></td>
        <td class="sticky-cell7 border-bottom" rowspan="2"><?= $contract->leaseTarget->registration_number ?></td>
        <td class="sticky-cell8 text-end border-bottom" rowspan="2"><?= number_format($detail->monthlyChargeWithTax, 0) ?></td>
        ...
        ?>
        <td rowspan="2" class="sticky-cell9 border-bottom text-end"><?= number_format($remains, 0) ?></td>
        <td class="sticky-cell10">回収額</td>
    ...
    <tr>
        ...
        <td class="sticky-cell10 border-bottom">残額</td>
        <?php foreach($terms as $term) :
