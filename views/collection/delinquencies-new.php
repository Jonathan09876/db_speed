...
EOL;
        ...
        foreach($terms as $term) {
            ...
            $layout .= <<<EOL
                <th style="width:140px;" colspan="2">{$termText}</th>
EOL;
...
EOL;
        ...
        $delinquencyWholeTotalText = number_format($delinquencyWholeTotal, 0);
        ...
        $layout .= <<<EOL
                <th class="text-end">{$delinquencyWholeTotalText}</th>
...
EOL;
        ...
        <?= ListView::widget([
            ...
            'itemView' => 'iv-collection-delinquencies-latest2',
