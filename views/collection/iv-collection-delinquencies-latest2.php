...
?>
    <tr>
        <td class="sticky-cell sticky-cell1 border-bottom" rowspan="3"><?= Html::a($customer->customer_code, ['/aas/customer', 'id' => $customer->customer_id]) ?></td>
        <td class="sticky-cell sticky-cell2 border-bottom" rowspan="3"><?= $customer->clientContract->repaymentPattern->name ?></td>
        <td class="sticky-cell sticky-cell3 border-bottom" rowspan="3"<?= $customerBgColor ? " style=\"background-color:{$customerBgColor}!important;\"" : '' ?>><?= Html::a($customer->getName(), ['/aas/customer', 'id' => $customer->customer_id]) ?></td>
        <td class="sticky-cell sticky-cell4 border-bottom" rowspan="3"><?= $customer->salesPerson->name ?></td>
        <td class="sticky-cell sticky-cell5 border-bottom" rowspan="3"><?= Html::a($contract->contractNumber, ['/aas/lease-contract', 'id' => $contract->lease_contract_id]) ?></td>
