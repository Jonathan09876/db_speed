(function ($) {
     ...
     */
    ModalAjax.prototype.formSubmit = function (evt) {
        //var form = jQuery(this.element).find('form');
        var form = jQuery(evt.target);
        var self = this;
        if (this.posted.includes(this.element_id)) return false;
        this.posted.push(this.element_id);
    ...
    ModalAjax.prototype.generateElementId = function(){
        var length = 16, chars = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!#$%&', generated = '';
        do {
            generated += chars[Math.floor(Math.random()*chars.length)];
        } while(generated.length < length);
        this.element_id = generated;
    };
